        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(text != "") {
                    ...
                    FragmentFeed.feedItems.add("Player"+  PlayerIdentifier + "edited health by: " + health); //TODO ADD PLAYER NAME
                    Toast.makeText(getApplicationContext(), "Player"+  PlayerIdentifier + "edited health by: " + health, Toast.LENGTH_LONG).show();
                    finish();
                }
                else {
                    //TODO ERROR
